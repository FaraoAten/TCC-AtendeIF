// Funções da tela de editar atendimento dos usuários do tipo professor
  ...
  function confirmar (confirm) {
    ...
    if(confirm){
      ajaxPut("atendimento", atendimento).then(function(result){
        ...
        AlterarModal('confirmacao','<button type="button" class="btn-close" onclick="window.location.replace(`./professorBase.html`);" data-bs-dismiss="modal"></button>')
