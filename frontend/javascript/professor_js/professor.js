...
window.onload = function () { 
    ...
    if(sessionStorage.getItem('primeiroLogin')==0){
        ...
        showMod('msg', '<button type="button" class="btn btn-primary btn-lg col-md-3 col-5 me-1 arredondado sombra" onclick="window.location.href=`./editarPerfilProfessor.html`" data-bs-dismiss="modal">Ok</button>');
        myModal.show();
